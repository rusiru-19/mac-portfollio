        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b">
              ...
              />
              <span className="ml-4 font-medium text-white/80">
            ...
            <div className="flex flex-1 overflow-hidden">
              {/* Sidebar */}
              <div className="w-60 bg-white/5 backdrop-blur-2xl p-4 border-r border flex flex-col items-center gap-4">
                <img
                  src={profile.avatar}
                  alt={profile.name}
                ...
                <h2 className="text-lg text-white/70 font-semibold">{profile.name}</h2>
                <p className="text-sm text-white/80">{profile.bio}</p>
                </div>
                <div className="flex gap-4 mt-2">
                  <div className="text-center">
                    <p className="font-bold text-white/70">{profile.followers}</p>
                    <p className="text-xs text-white/80">Followers</p>
                  </div>
                  <div className="text-center">
                    <p className="font-bold text-white/70">{profile.following}</p>
                    <p className="text-xs text-white/80">Following</p>
                  </div>
                  <div className="text-center">
                    <p className="font-bold text-white/70">{profile.repos}</p>
                    <p className="text-xs text-white/80">Repos</p>
                  </div>
              ...
              <div className="flex-1  p-6 overflow-auto">
                ...
                <div className="flex-1 overflow-auto p-6 bg-white/10 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 text-white/80 space-y-4">
                    ...
                    <p className="mt-4 text-white/80 italic text-center">
