...
export default function LinkedInWindow({ isOpen, onClose, width, height, setWidth, setHeight }) {
  ...
  const profile = {
    ...
    posts: ['<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7403830079371612160?collapsed=1" height="503" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>',
        '<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7393201648489226241?collapsed=1" height="547" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>' ,
        '<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7377224044275945472?collapsed=1" height="670" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>'
    ]
        ...
        >
          ...
          >
            ...
            <div className="flex flex-1 overflow-hidden">
              {/* Sidebar */}
              <div className="w-64 bg-[#f3f6f8] p-5 border-r overflow-auto">
                <img
                  src={profile.avatar}
                  alt={profile.name}
